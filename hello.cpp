...
void greetings_1302210036(string x, string y){
    if(y.length() != 10){
...
void swap_1_1302210036(int a, int b, int c){
    c = b;
    b = a;
    a = c*b++;
}

void swap_2_1302210036(int a, int &b, int &c){
    c = b;
    b = a;
    a = c*b++;
}

void confused_1302210036() {
    int x1 = 5;
    int x2 = 5;
    int x3 = 5;
...
void remove_inside_1302210036(int x){
...
string indexing_1302210036(double x, double y, double z){
